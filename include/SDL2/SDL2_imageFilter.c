...
\param Src1 Pointer to the start of the first src byte array (S1).
\param Src2 Pointer to the start of the second src byte array (S2).
\param Dest Pointer to the start of the destination byte array (D).
\param SrcLength The number of bytes in the src arrays.
...
\param Src2 Pointer to the start of the second src byte array (S2).
\param Dest Pointer to the start of the destination byte array (D).
\param length The number of bytes in the src arrays.
...
\param Src1 Pointer to the start of the src byte array (S1).
\param Dest Pointer to the start of the destination byte array (D).
\param SrcLength The number of bytes in the src array.
...
\param Src1 Pointer to the start of the src byte array (S).
\param Dest Pointer to the start of the destination byte array (D).
\param length The number of bytes in the src array.
...
\param Src Pointer to the start of the src byte array (S).
\param Dest Pointer to the start of the destination byte array (D).
\param length The number of bytes in the src array.
...
\param Src The src 2D byte array to convolve. Should be different from destination.
\param Dest The destination 2D byte array to store the result in. Should be different from src.
\param rows Number of rows in src/destination array. Must be >2.
\param columns Number of columns in src/destination array. Must be >2.
...
\param Src The src 2D byte array to convolve. Should be different from destination.
\param Dest The destination 2D byte array to store the result in. Should be different from src.
\param rows Number of rows in src/destination array. Must be >4.
\param columns Number of columns in src/destination array. Must be >4.
...
\param Src The src 2D byte array to convolve. Should be different from destination.
\param Dest The destination 2D byte array to store the result in. Should be different from src.
\param rows Number of rows in src/destination array. Must be >6.
\param columns Number of columns in src/destination array. Must be >6.
...
\param Src The src 2D byte array to convolve. Should be different from destination.
\param Dest The destination 2D byte array to store the result in. Should be different from src.
\param rows Number of rows in src/destination array. Must be >8.
\param columns Number of columns in src/destination array. Must be >8.
...
\param Src The src 2D byte array to sobel-filter. Should be different from destination.
\param Dest The destination 2D byte array to store the result in. Should be different from src.
\param rows Number of rows in src/destination array. Must be >2.
\param columns Number of columns in src/destination array. Must be >7.
