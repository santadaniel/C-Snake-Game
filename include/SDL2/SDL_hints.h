...
*  can use two different sets of binaries, those compiled by the user from src
...
*    "none" - do not load any library, useful if you compiled ANGLE from src and included the compiler in your binaries.
*
*/
 ...
 *  The preprocessor define is left here for src compatibility.
 */
 ...
 *  appears to be an audio src or sink. This will add "devices" to the list
